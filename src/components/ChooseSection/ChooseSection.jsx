  ...
  return (
    <div>
        <div className="container">
            <h2 className='text-center mb-5'>Why NSAST?</h2>
            <div className='row g-4'>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        <div className='mt-3'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"  fill="#3ABEF9" class="bi bi-trophy-fill" viewBox="0 0 16 16">
                ...
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        <div className='mt-3'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#3ABEF9" class="bi bi-emoji-smile-fill" viewBox="0 0 16 16">
                ...
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        <div className='mt-3'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#3ABEF9" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
